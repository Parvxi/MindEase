...
def main():
    ...
    your_app_client_id = 'B98FSmalCKHeVN6qWPhBqYFs6P2vCz5nJk31FoLH'
    your_app_client_secret = 'DYoIMKkjOj0mrLhDTfrQkCVbPYPbDW0DKYcBPqD4Yk9P2eHcQVGo7PFklejp4itbkZOTMz3glDzWNeMoKT8B16N6jx4V9Ya4Esw3nVJiuJf27e715V2rKqcaNpgirTU7'
    ...
    r.record_title = 'SABAH2' # required param and can not be empty
    r.record_description = '' # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = 'on desktop' # your place to export, you should have write permission, example on desktop
